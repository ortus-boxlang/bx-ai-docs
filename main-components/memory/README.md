...
For advanced patterns including security considerations, filtering strategies, and enterprise multi-tenancy, see the [Multi-Tenant Memory Guide](multi-tenant/README.md).
...
Per-call `userId` / `conversationId` is the supported isolation mechanism — you do **not** need one agent instance per user. See [Multi-Tenant Memory Guide](multi-tenant/README.md).
...
Reusable patterns for building conversation memory into your applications — conversation managers, multi-user isolation, contextual switching, and summarization — have moved to [Memory Patterns & Examples](patterns-and-examples.md).
...
Worked examples combining memory with RAG, multi-agent systems, and other advanced scenarios have moved to [Memory Patterns & Examples](patterns-and-examples.md).
...
* [Multi-Tenant Memory Guide](multi-tenant/README.md) - Enterprise multi-tenant isolation patterns
* [Memory Patterns & Examples](patterns-and-examples.md) - Reusable patterns and advanced examples
